package com.blamejared.botanypotstweaker.gradle
...
class DefaultPlugin : Plugin<Project> {
    ...
    private fun setupDefaults(project: Project) {
        ...
        project.repositories {
            ...
            this.add(this.maven("https://cursemaven.com") {
                content {
    ...
    private fun applyJavaPlugin(project: Project) {
        ...
        project.tasks {
            ...
            withType<JavaCompile> {
                ...
                this.options.compilerArgs.add("-Acrafttweaker.processor.document.output_directory=${project.rootProject.file("docsOut")}")
